...
namespace MuffinProtoBuf.Serializers
{
    ...
    {
        bool IProtoTypeSerializer.HasCallbacks(MuffinProtoBuf.Meta.TypeModel.CallbackType callbackType) { return false; }
#if FEAT_COMPILER
        ...
        void IProtoTypeSerializer.Callback(object value, MuffinProtoBuf.Meta.TypeModel.CallbackType callbackType, SerializationContext context) { }
#endif
