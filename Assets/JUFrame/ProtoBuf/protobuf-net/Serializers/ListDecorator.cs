...
namespace MuffinProtoBuf.Serializers
{
    class ListDecorator : ProtoDecoratorBase
    {
        ...
        internal static void EmitReadList(MuffinProtoBuf.Compiler.CompilerContext ctx, Compiler.Local list, IProtoSerializer tail, MethodInfo add, WireType packedWireType, bool castListForAdd)
        {
