...
namespace MuffinProtoBuf
{
 ...
 double ReadDouble()
        ...
        public int ReadFieldHeader()
        {
            ...
            if (wireType == MuffinProtoBuf.WireType.EndGroup)
            {
        ...
        public void SkipField()
        {
            switch (wireType)
            {
                ...
                case WireType.StartGroup:
					...
					wireType = MuffinProtoBuf.WireType.None;
                        return;
                    }
                    throw CreateWireTypeException();
 ...
 float ReadSingle()
        ...
        /// </summary>
        public static bool HasSubValue(MuffinProtoBuf.WireType wireType, ProtoReader source)
        {
            if (source == null) throw new ArgumentNullException("source");
            // check for virtual end of stream
